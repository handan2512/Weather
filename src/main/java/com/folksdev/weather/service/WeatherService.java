...
public class WeatherService {
    ...
    public WeatherDto getWeatherByCityName(String city) { //veritabanından var mı diye kontrrol eder
    ...
    private WeatherEntity getWeatherFromWeatherStack(String city) { //apıden veri alır
